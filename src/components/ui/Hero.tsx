...
const Hero = () => {
  return (
    <section className="bg-white dark:bg-[#0e172c] lg:grid lg:h-1/4 lg:place-content-center font-sans">
      <div className="mx-auto w-screen max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-8 lg:pb-24">
        <div className="max-w-prose">
          ...
          <div className="mt-4 flex gap-4 sm:mt-6">
            ...
            <a
              className="inline-block rounded-[16px] border border-[#EBF5FE] bg-[#EBF5FE] px-5 py-3 font-medium text-[#002370] shadow-sm transition-colors hover:bg-[#dceefa]"
              href="#"
            >
              Learn More
            </a>
